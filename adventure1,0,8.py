...
def journey():
    ...
    while exp<5:
        ...
        if day==0:
            ...
            print('you wake up a new day, and travel into a '+terrain+' by noon.')
        ...
        while terrain=='forest' and valid==False:
            ...
            if com=='/sneak':
                ...
                print('invalid command please try again')
                valid=False
        while terrain=='mountain' and valid==False:
            print('As you come to a narrow pass near the mountain top you hear a strange sound')
        ...
        if terrain=='grassland':
            ...
            if Pass==False:
                ...
                print('you see a bear tiger attempting to sneak up on you.')
        if fight==True:
            valid=True
            if terrain=='desert':
            ...
            if WinFight[0]==True and WinFight[1]==False:
                ...
                if monloot=='an axe':
                    ...
                    armor=statget('characters.txt',playername,'armor')
                    armor=armor+1
...
def endscreen(win):
    ...
    changestat('characters.txt',playername,'score', wins)
    while valid==False:
        com=input()
        if com=='/exit':
            valid=True
